...
# 数据读取
cap = cv2.VideoCapture('D:\\Unet\\unet\\1097正常料.avi')
...
while cap.isOpened():
    ...
    # # GMM三通道彩色图
    # plt.figure(3)
    # plt.imshow(GMM_yt_3_RGB)
    # plt.xticks([])
    # plt.yticks([])
    # plt.title("GMM_yt_3_RGB")
    #
    # plt.figure(4)
    # plt.imshow(outcome_GMM_3D_RGB_1)
    # plt.xticks([])
    # plt.yticks([])
    # plt.title("outcome_GMM_3D_RGB_1")
    #
    # plt.figure(5)
    # plt.imshow(outcome_GMM_3D_RGB)
    # plt.xticks([])
    # plt.yticks([])
    # plt.title("outcome_GMM_3D_RGB")
    #
    # # GMM二值图
    # plt.figure(6)
    ...
    # # GMM二值图
    # plt.figure(7)
    # plt.imshow(outcome_GMM_gray_2D_1,cmap='gray')
    # plt.xticks([])
    # plt.yticks([])
    # plt.title("outcome_GMM_gray_2D_1")
    #
    # # GMM二值图
    # plt.figure(1)
    # plt.imshow(rongyan_and_huoyan,cmap='gray')
    # plt.xticks([])
    # plt.yticks([])
    # plt.title("rongyan_and_huoyan")
    #
    # plt.figure(2)
    # plt.imshow(rongyan_and_huoyan_3D_RGB)
    # plt.xticks([])
    # plt.yticks([])
    # plt.title("rongyan_and_huoyan_3D")
    ...
    axes[1, 3].imshow(outcome_GMM_gray_2D, cmap='gray')
    ...
    # cv2.imshow("GMM_yt_3_RGB", GMM_yt_3_RGB)
    # cv2.imshow("outcome_GMM_3D_RGB", outcome_GMM_3D_RGB)
    # cv2.imshow("dilated", dilated)
    # cv2.imshow("outcome_GMM_gray_2D", outcome_GMM_gray_2D)
